...
export const ClientsCard = () => {
    return(
        <Flex justifyContent='space-around' bg='white' p='25' borderRadius='0px 10px 0px 10px' >
            ...
            <Flex h='0'>
                <IconButton aria-label='editar' icon={<DeleteIcon />} color='blue' border='none' bg='transparent' h='0'/>
                <IconButton aria-label='deletar' icon={<EditIcon />}color='red' border='none' bg='transparent' h='0'/>
            </Flex>
        </Flex>
    )   
}
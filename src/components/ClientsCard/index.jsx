...
export const ClientsCard = () => {
    return(
        <Flex bg='white' h='200px' p='25' gap='20px' borderRadius='0px 10px 0px 10px'>
            ...
            <FormControl display='flex' top='20px' justifyContent='center' textAlign='center' alignItems='center' bg='#D9D9D9' w='100px' h='100px' borderRadius='0px 10px 0px 10px'>
